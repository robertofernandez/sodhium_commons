...
public class ObjectPersistenceManagerWithShutdownHook extends ObjectPersistenceManager {
    private AtomicBoolean shutdown;
    private TaskExecutor executor;
    private ShutdownHook shutdownHook;
    private ExceptionsListener exceptionsListener;

    public ObjectPersistenceManagerWithShutdownHook(ShutdownHook shutdownHook, String name,
    ...
    private void performWriting(Object element, String filePath) throws IOException {
